...
5. MATLAB scripts to recreate:
		a. the two main figures included in the manuscript (Figure 4 and Figure 5), presenting the results for the moment arms of the highly discretized muscles.
...
- [ ] link to *work in progress* repository